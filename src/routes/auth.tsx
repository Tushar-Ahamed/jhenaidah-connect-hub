...
import { UPAZILAS, rollToEmail } from "@/lib/constants";
...
function AuthPage() {
  ...
  async function handleLogin(e: React.FormEvent) {
    ...
    try {
      ...
      toast.error(err?.message ?? "লগইন ব্যর্থ — রোল/রেজিস্ট্রেশন নম্বর দেখুন");
    } finally {
      setBusy(false);
    }
  }
          ...
          {mode === "login" ? (
            ...
            <form onSubmit={handleRegister} className="space-y-3">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <Field label="রেজিস্ট্রেশন নম্বর" value={rReg} onChange={setRReg} />
              </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <Field label="হল" value={rHall} onChange={setRHall} />
                <div>
              ...
              <Field label="মোবাইল" value={rPhone} onChange={setRPhone} />
              <button disabled={busy} className="w-full rounded-lg bg-primary px-4 py-3 text-sm font-semibold text-primary-foreground disabled:opacity-60">
